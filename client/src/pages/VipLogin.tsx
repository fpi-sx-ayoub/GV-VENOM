    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">VIP Login</h1>
          <p className="text-slate-400 mt-2">Access your VIP account</p>
        </div>
        ...
        {/* Info Box */}
        <div className="mt-6 bg-purple-500/10 border border-purple-500/20 rounded-lg p-4 text-center">
          <p className="text-sm text-slate-300">
            Don't have an account? <br />
            <span className="text-purple-400">Contact the administrator</span>
          </p>
        </div>
      </div>
    </div>
